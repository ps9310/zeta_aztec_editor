...
class AztecFlutterApi(
    ...
    fun onFileSelected(
        ...
        val separatedMessageChannelSuffix =
            if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
        val channelName =
            "dev.flutter.pigeon.zeta_aztec_editor.AztecFlutterApi.onFileSelected$separatedMessageChannelSuffix"
    ...
    fun onFileDeleted(
        ...
        val separatedMessageChannelSuffix =
            if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
        val channelName =
            "dev.flutter.pigeon.zeta_aztec_editor.AztecFlutterApi.onFileDeleted$separatedMessageChannelSuffix"
        val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
        channel.send(listOf(editorTokenArg, filePathArg)) {
            if (it is List<*>) {
                if (it.size > 1) {
